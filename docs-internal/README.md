...
This folder stores internal and technical reference notes for maintainers and AI agents.
...
- [PHP version strategy (GPT-5.3-Codex variant)](php-version-strategy-gpt53.md)
