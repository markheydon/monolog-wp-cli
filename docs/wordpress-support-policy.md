...
This policy complements, but does not replace, the package runtime policy in `docs/php-version-strategy.md`.
...
- Keep `README.md`, `website/content/docs/explanation/compatibility-and-release-line-policy.md`, `docs/test-under-wordpress.md`, and `.github/workflows/php.yml` aligned with the current tuple list.
